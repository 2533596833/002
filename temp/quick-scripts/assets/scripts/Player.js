...
cc._RF.push(module, '3bcd08h5dJBzp9ijI54xvAf', 'Player', __filename);
// scripts/Player.js
...
cc.Class({
    ...
    update: function update(dt) {
        ...
        if (this.node.x > this.can.width / 2) {
            this.node.x = -this.can.width / 2;
        } else if (this.node.x < -this.can.width / 2) {
            this.node.x = this.can.width / 2;
        }
